...
<table width="100%" bgcolor="#f5f5f5" style="background-color:#f5f5f5;" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table class="full_width" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #d9d9d9;" >
        ...
        <!--<tr><td width="100%" style="border-top:1px solid #d9d9d9;"></td></tr>-->
      </table>  
     ...
     <table align="center" width="100%">      
       ...
       <tr> <td ><p>Firstname :- <?php echo $firstname ?></p></td></tr>
       <tr><td></td> </tr>
       <tr><td><p> Lastname :-  <?php echo $lastname?></p></td> </tr>
        <tr><td></td> </tr>
       <tr> <td ><p>Email Id :- <?php echo $email ?></p></td></tr>
       <tr><td></td> </tr>
       <tr><td><p> Phone  <?php echo $phone?></p></td> </tr>
        <tr><td></td> </tr>
       <tr> <td ><p>Message :- <?php echo $message ?></p></td></tr>
       <tr><td></td> </tr>
       <tr><td><p> Tour Name:-  <?php echo $tourname?></p></td> </tr>
        <tr><td></td> </tr>
     </table>
